...
After you push your changes to GitHub, a workflow will be running, and you will see either an orange circle (tests are currently running), a red X (tests have failed), or a green checkmark (tests have passed).
When you see a green checkmark, this is how you know you are done.  If you see a red X, then click on the red X to see what tests have failed.
